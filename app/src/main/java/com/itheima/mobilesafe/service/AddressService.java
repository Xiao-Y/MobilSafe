...
public class AddressService extends Service {
    ...
    class OutCallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // 查询数据库
            String address = NumberAddressQueryUtils.queryNumber(MyApplication.getContext(), phone);
            myToast(address);
        }
    }
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:// 来电铃声响起
                    // 查询数据库的操作
                    String address = NumberAddressQueryUtils.queryNumber(MyApplication.getContext(), incomingNumber);
                    myToast(address);
                    break;
